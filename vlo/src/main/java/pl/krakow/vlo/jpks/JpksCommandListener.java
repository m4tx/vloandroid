 ...
 * {@link JpksClient#setCommandListener(JpksCommandListener)} method.
 */
public interface JpksCommandListener {
    /**
     * Called when <code>{@value JpksClient#COMMAND_CLEAR}</code> command is
     ...
     * <code>{@value JpksClient#COMMAND_QUESTION}</code>.
     *
     ...
     * Command: <code>{@value JpksClient#COMMAND_CORRECT_ANSWER}</code>.
     *
     ...
     * <code>{@value JpksClient#COMMAND_MESSAGE}</code>.
     *
     ...
     * <code>{@value JpksClient#COMMAND_IMAGE}</code>.
     * <p/>
     ...
     * <code>{@value JpksClient#COMMAND_COUNT}</code>.
     *
     ...
     * <code>{@value JpksClient#COMMAND_CLEAR_RANKING}</code>.
     */
    void onClearRanking();

    /**
     * Called when the new line of ranking is sent. Usually called multiple times at once.
     * Command: <code>{@value JpksClient#COMMAND_APPEND_RANKING}</code>.
     *
     ...
     * <code>{@value JpksClient#COMMAND_POINT_GOT}</code>.
     *
     ...
     * The command is: <code>{@value JpksClient#COMMAND_REPAINT}</code>.
     * <p/>
